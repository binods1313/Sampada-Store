...
class SafeImageBuilder {
  ...
  width(w) {
    this._inner = this._inner.width(w);
    return this;
  }
  height(h) {
    this._inner = this._inner.height(h);
    return this;
  }
  quality(q) {
    this._inner = this._inner.quality(q);
    return this;
  }
  format(f) {
    this._inner = this._inner.format(f);
    return this;
  }
  auto(a) {
    this._inner = this._inner.auto(a);
    return this;
  }
  fit(f) {
    this._inner = this._inner.fit(f);
    return this;
  }
  rect(...args) {
    this._inner = this._inner.rect(...args);
    return this;
  }
  sharpen(s) {
    this._inner = this._inner.sharpen(s);
    return this;
  }
  dpr(d) {
    this._inner = this._inner.dpr(d);
    return this;
  }
  crop(c) {
    if (typeof this._inner.crop === 'function') {
      this._inner = this._inner.crop(c);
    }
    return this;
  }
  focalPoint(...args) {
    if (typeof this._inner.focalPoint === 'function') {
      this._inner = this._inner.focalPoint(...args);
    }
    return this;
  }
  ignoreImageParams() {
    if (typeof this._inner.ignoreImageParams === 'function') {
      this._inner = this._inner.ignoreImageParams();
    }
    return this;
  }
  url() {
