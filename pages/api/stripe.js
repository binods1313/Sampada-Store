...
export const config = {
  api: {
    bodyParser: {
      sizeLimit: '1mb' // For regular requests
    },
  },
};
...
export default async function handler(req, res) {
  if (req.method === 'POST') {
    ...
    try {
      ...
      console.timeEnd('StripeApiRequest'); // Ensure timer ends on error too
      ...
      console.timeEnd('StripeApiRequest'); // Log overall request duration
      console.log('--- Stripe API Request Handler Finished ---\n');
    }
