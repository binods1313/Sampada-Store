...
import { ChevronLeft, Package, LayoutGrid, List, Tag, ShoppingCart, Users, Star, Sparkles, Bot, BarChart3, Settings, LogOut } from 'lucide-react'
...
const NAV = [
  ...
  },
  {
    ...
    items: [
      ...
      { icon: Users, label: 'Users', href: '/admin/dashboard/users', badge: null, planned: true },
      { icon: Star, label: 'Reviews', href: '/admin/dashboard/reviews', badge: null, planned: true },
    ]
  },
  {
    section: 'Tools',
    items: [
      ...
      { icon: Bot, label: '🤖 AI Hub', href: '/admin/ai-hub', badge: null },
      { icon: BarChart3, label: 'Analytics', href: '/admin/analytics', badge: null },
      { icon: Settings, label: 'Settings', href: '/admin/dashboard/settings', badge: null, planned: true },
    ]
  }
]
