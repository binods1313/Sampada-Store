    ...
    fields: [
      {
        ...
        title: 'Meta Title',
        type: 'string',
        description: 'Recommended: up to 70 characters. Appears in search results and browser tabs.',
      ...
      },
      {
        ...
        type: 'text',
        rows: 3,
        description: 'Recommended: up to 180 characters. Appears under the title in search results.',
        validation: Rule => Rule.max(180).warning('Longer descriptions may be truncated in search results'),
      },
      {
        name: 'keywords',
